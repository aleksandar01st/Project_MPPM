...
namespace FTN {
    ...
    public class Curve : IdentifiedObject {
        ...
        private List<CurveData> cim_CurveDatas = new List<CurveData>();
        
        private const bool isCurveDatasMandatory = false;
        
        private const string _CurveDatasPrefix = "cim";
        ...
        public virtual List<CurveData> CurveDatas {
            get {
                return this.cim_CurveDatas;
            }
            set {
                this.cim_CurveDatas = value;
            }
        }
        
        public virtual bool CurveDatasHasValue {
            get {
                return this.cim_CurveDatas != null;
            }
        }
        
        public static bool IsCurveDatasMandatory {
            get {
                return isCurveDatasMandatory;
            }
        }
        
        public static string CurveDatasPrefix {
            get {
                return _CurveDatasPrefix;
            }
        }
